          ...
          <div className="lg:flex lg:items-center lg:justify-between px-10">
            <div className="w-full space-y-12 lg:w-1/2 ">
              ...
              <div className="md:flex md:items-start md:-mx-4">
                <span className="inline-block p-2 text-orange-500 bg-orange-100 rounded-xl md:mx-4  ">
                  <svg
            ...
            <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center relative w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem]">
              <Image
